...
const wait = (duration: number) => new Promise(reslove => setTimeout(reslove, duration))
...
export default async function AdminDashboard(){
    ...
    return <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <DashboardCard title="Products" subtitle={`${formatNumber(productData.inactiveProducts)}  archived products`}  body={formatNumber(productData.inactiveProducts)}/>
    </div>
}
